(module
  ...
  (type (;3;) (func (param i32 i32 i32 i32 i32 i32 i64 i64 i64 i64)))
  ...
  (func $user_entrypoint (type 1) (param i32 i32)
    ...
    call $abort
    unreachable)
  (func $core::integer::U32Add::add (type 2) (param i32 i32 i32)
    ...
    call $abort
    unreachable)
  (func $core::result::ResultTraitImpl::<core::integer::u32__core::integer::u32>::expect::<core::integer::u32Drop> (type 3) (param i32 i32 i32 i32 i32 i32 i64 i64 i64 i64)
  ...
  (func $call_memory_grow (type 0) (param i32)
    ...
    global.set $__stack_pointer
    return)
  (func $realloc (type 4) (param i32 i64) (result i32)
